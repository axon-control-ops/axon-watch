...
<template>
  <div class="agent-dock-composer__tool-group">
    ...
    <div
      v-if="showModeMenu"
      class="agent-dock-composer__menu agent-dock-composer__menu--mode"
    >
      ...
      <div
        v-if="composerMode === 'agent' || composerMode === 'debug'"
        class="agent-dock-composer__menu-section"
      >
        ...
        >
          <span>⬡ Full Access tools</span>
          <small>{{ agentExecutionAccessHint('full') }}</small>
        </button>
      </div>
      <div class="agent-dock-composer__menu-section">
