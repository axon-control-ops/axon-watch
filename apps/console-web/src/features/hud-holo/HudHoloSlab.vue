...
onMounted(() => {
  ...
  fetch('http://127.0.0.1:7706/ingest/90bcaec2-2b39-4d4a-84b5-157c12735440', {
    ...
    body: JSON.stringify({
      sessionId: 'fc0b35',
      runId: 'holo-frame-fix',
      hypothesisId: 'H-clean-edges',
      location: 'HudHoloSlab.vue:onMounted',
      message: 'clean 3D panel edge geometry active',
      data: {
        frameGeometry: frameGeometry.type,
        innerGeometry: innerGeometry.type,
