...
def ask_fence_instruction() -> str:
    ...
    return (
        ...
        "Do not call Cursor AskQuestion or CreatePlan — both hang in this headless "
        "runtime and leave the operator with an empty tool block instead of your answer. "
        "Write any plan, findings, or next steps directly in your reply body instead. "
