...
- [ ] **G3.4** Stop/resume/cancel maps to runtime process control, not prompt cancellation alone
- [ ] **G3.5** MCP tool surface registered in control-plane; no ad hoc tool strings in shell
